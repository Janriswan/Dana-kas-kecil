...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/kas.png">
    <title>Dana Kas Kecil by Janriswan</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
                <div class="top-left-part"><a class="logo" href="<?= base_url ?>"><b><img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/download.png" alt="home" /></div>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> <?php echo date('Y'); ?> &copy; Janriswan </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
    ...
    $(document).ready(function() {
        ...
        $.toast({
            heading: 'Selamat Datang di Dana Kas Kecil',
            text: 'Aplikasi pengelolaan Kas by Janriswan.',
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'info',
            hideAfter: 3500,
